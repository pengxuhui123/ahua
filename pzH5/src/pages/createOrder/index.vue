    ...
    <div class="container">
        ...
        <van-cell-group class="cell">
            ...
            <van-cell>
                ...
                <template #default>
                    <div @click="showStartTime = true">{{ currentDate || '请选择就诊时间' }}<van-icon name="arrow" /></div>
                </template>
            </van-cell>
            <van-cell>
            ...
            <van-cell>
                ...
                <template #default>
                    <van-field class="text" input-align="right" v-model="form.tel" placeholder="请填写您的联系电话" />
                </template>
            </van-cell>
        </van-cell-group>
        <van-cell-group title="服务需求" class="cell">
            <van-field  style="height:100px" v-model="form.demand" placeholder="请简单描述你要就诊的科室.." />
        </van-cell-group>
        <van-button type="primary" @click="submit" class="submit" size="large">提交订单</van-button>
        ...
        <van-popup v-model:show="showStartTime" @confirm="showHospConfirm" @cancel="showStartTime = false"
...
//监听一个数据变化优先使用计算属性，计算属性要携带return
